...
// Because it is inside the function myFunction and declared be for being invoked
...
const zooAnimals = [
  ...
  */
  function lowPopulationAnimals(data){
    const lowPopAnimals = data.filter(function(item){
  ...
  */
  function USApop(data){
    const USpop = data.reduce(function(accumlator, item){
